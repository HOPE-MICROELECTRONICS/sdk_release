...
//#define  RF_CTRL_MODE                       RF_TX_ONLY
#define  RF_CTRL_MODE                       RF_RX_ONLY

#define  RF_SWITCH_DELAY                    500   //500ms

#if(RF_CTRL_MODE == RF_TX_ONLY)
#define  RF_TX_INTV                         50  //50ms
#else  //(RF_CTRL_MODE == RF_RX_ONLY)
#define  RF_RX_INTV                         1000  //1000ms
#define  RF_RX_WINDOW                       1000   //500ms
#endif 


/* Device name */
#define CUSTOM_DEVICE_NAME                  "HP_RDTS_P"
