...
void app_key1_press_handler(void);
void app_key2_press_handler(void);
//void app_keyAB_press_handler(void);
void app_keyA_press_handler(void);
void app_keyB_press_handler(void);
#ifdef __cplusplus
}
#endif
