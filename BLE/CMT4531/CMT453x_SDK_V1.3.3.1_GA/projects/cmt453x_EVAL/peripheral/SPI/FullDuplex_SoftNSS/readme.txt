...
3. Instructions for use
    ...
    Instructions:
        ...
        2. SPI1 is initialized as a central, sending data, SPI2 is initialized as a peripheral, receiving data, 
        after the transmission is completed, check the data, and check that the status of TransferStatus1 
        and TransferStatus2 is PASSED; SPI2 is initialized as a central, sending data, SPI1 is initialized 
        as a peripheral, receiving data, after the transmission is completed, check the data, and check that 
