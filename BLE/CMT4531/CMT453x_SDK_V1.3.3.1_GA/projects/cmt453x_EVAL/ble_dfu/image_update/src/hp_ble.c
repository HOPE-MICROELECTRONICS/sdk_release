...
#include <string.h>
#include <stdio.h>
#include "hp_ble_task.h"                // Application task Definition
#include "hp_ble.h"                     // Application Definition
...
#if (BLE_APP_HP_IUS)
#include "app_hp_ius.h"                 // HP_IUS Application Definitions
...
static const app_add_svc_func_t app_add_svc_func_list[APP_SVC_LIST_STOP] =
{
    ...
    #endif //(BLE_RDTSS_SERVER)
    #if (BLE_APP_HP_IUS)
    (app_add_svc_func_t)app_hp_ius_add_hp_ius,
    #endif //(BLE_APP_HP_IUS)        
};
