...
1. Function description
    ...
    After connecting the peripheral device, the data received by Bluetooth will be transparently 
    transmitted to USART1, and the data received by USART1 will be transparently transmitted 
    to the peripheral device.
    This example is allow connect up to 3 peripheral deivce(rdtss example). It needs to set the 
...
3. Instructions
    ...
    System configuration;
        ...
        6. The counter test routine is the rdtss peripheral routine in the ble directory
