 ...
 *
  */
#ifndef __CMT453X_H__
#define __CMT453X_H__

#ifdef __cplusplus
extern "C" {
#endif

/** @addtogroup CMT453X_Library_Basic
 * @{
 */
...
#define __CMT453X_STDPERIPH_VERSION_MAIN (0x01) /*!< [31:24] main version */
#define __CMT453X_STDPERIPH_VERSION_SUB1 (0x00) /*!< [23:16] sub1 version */
#define __CMT453X_STDPERIPH_VERSION_SUB2 (0x00) /*!< [15:8]  sub2 version */
#define __CMT453X_STDPERIPH_VERSION_RC   (0x00) /*!< [7:0]  release candidate */

/**
 * @brief CMT453X Standard Peripheral Library version number
 */
#define __CMT453X_STDPERIPH_VERSION                                                                                    \
    ((__CMT453X_STDPERIPH_VERSION_MAIN << 24) | (__CMT453X_STDPERIPH_VERSION_SUB1 << 16)                               \
     | (__CMT453X_STDPERIPH_VERSION_SUB2 << 8) | (__CMT453X_STDPERIPH_VERSION_RC))

/*
 * Configuration of the Cortex-M0 Processor and Core Peripherals
 */
#define __NVIC_PRIO_BITS       2 /*!< CMT453X uses 4 Bits for the Priority Levels    */
#define __Vendor_SysTickConfig 0 /*!< Set to 1 if different SysTick Config is used */

/**
 * @brief CMT453X Interrupt Number Definition
 */
typedef enum IRQn
{
    ...
    /******  CMT453X specific Interrupt Numbers ********************************************************/
...
/* CMT453X Standard Peripheral Library old definitions (maintained for legacy purpose) */
